...
import { createProfessionalStyles } from './Styles';
import { stripHtml } from '../pdf/utils';

export default function PdfProfessional({
  personalDetails,
  professionalSummary,
  workExperiences,
  educationEntries,
  ...
  const styles = createProfessionalStyles(accentColor);
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {orderedSections.map((s) => {
          // same section rendering pattern as Modern
          switch (s.id) {
            case 'summary': /* ... identical to Modern but using styles ... */ return (
